            ...
            <div className='px-[25px] pb-[60px] '>
                ...
                <div className=' grid md:grid-cols-6 grid-cols-1  font-[300]'>
                   <div className='mt-5 mb-7 md:col-start-1 col-span-4 '>
                    <p className=' text-[18px] text-[#696969] pt-[120px]'>We update applications to make compatible with new technologies, 
                    and we make error checks and bug fixes.</p></div>
